...
namespace ph { namespace ffmpeg {
	...
	MovieGl::MovieGl( cinder::DataSourceRef dataSource, const std::string mimeTypeHint) :
		mWidth(0),
		mHeight(0),
		mDuration(0.0f),
		mVideoClock(0.0),
    ...
    float MovieGl::getDuration() const
    {
        return mMovieDecoder->getDuration();
    }
