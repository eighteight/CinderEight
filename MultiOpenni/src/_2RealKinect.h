...
#include "_2RealImplementationOpenNI.hpp"
...
class _2RealKinect
{
	...
	private:
		...
		boost::shared_ptr<_2RealImplementationOpenNI>		m_Implementation;
		static _2RealKinect*							m_Instance;
    
public:
    std::vector<boost::shared_ptr<OpenNIDevice> >getDevices(){
        return m_Implementation->getDevices();
    }
};
