...
public:
	...
	MovieGl( cinder::DataSourceRef dataSource, const std::string mimeTypeHint = "");
	...
	static MovieGlRef create( cinder::DataSourceRef dataSource, const std::string mimeTypeHint = "" )
