...
class DeferredRenderingApp : public AppBasic
{
public:
...
void DeferredRenderingApp::drawNonShadowCasters(gl::GlslProg* deferShader) const
{
    int size = 3000;
...
CINDER_APP_BASIC( DeferredRenderingApp, RendererGl )
