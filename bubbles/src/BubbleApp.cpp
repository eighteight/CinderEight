...
class BubbleApp : public AppBasic {
  public:	
	gl::GlslProg		mShader;
	...
	void setup()
	{
        ...
        mSurface = new Surface8u(512,512, false);
	...
	void draw()
	{
		...
		(*mCubeMap).bindMulti(CUBE_MAP_LOC);
...
CINDER_APP_BASIC( BubbleApp, RendererGl )