...
class SilkAudioApp : public ci::app::AppBasic
{
public:
	// Cinder events
	...
	void drawBezier(ci::Vec2f origin, ci::Vec2f control, ci::Vec2f destination, const int segments);
	// Colors and states
